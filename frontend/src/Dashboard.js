...
function Dashboard({ onLogout }) {
    ...
    const refreshData = async () => {
        try {
            ...
            setStatus({ api: healthRes.data.status === 'healthy' ? 'ONLINE' : 'DOWN' });
                ...
                <div className="col-md-8">
                    ...
                    <table className="table table-striped">
                        ...
                        <tbody>
                            {orders.map((o) => (
                                <tr key={o.order_uuid}>
                                    <td><small>{o.order_uuid}</small></td>
                            ...
                            {orders.length === 0 && <tr><td colSpan="4">No hay pedidos nuevos en esta sesión.</td></tr>}
                        </tbody>
                    </table>
                </div>
            </div>
